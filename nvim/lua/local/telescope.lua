...
vim.api.nvim_set_keymap("n", "<space>w", "<cmd>lua require('fzf-lua').spell_suggest()<CR>", opts("Spell suggestions"))
...
vim.api.nvim_set_keymap("n", "gi", "<cmd>lua require('fzf-lua').lsp_implementations()<CR>", opts("LSP implementations"))
